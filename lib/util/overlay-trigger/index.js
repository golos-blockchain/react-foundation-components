...
var OverlayTrigger = function (_Component) {
  ...
  function OverlayTrigger(props) {
    ...
    _this.getOverlayContainer = function () {
      return (0, _getContainer2.default)(_this.props.container, (0, _ownerDocument2.default)(_this.targetRef.current).body);
    };
  ...
  (0, _createClass3.default)(OverlayTrigger, [{
    ...
    value: function render() {
      ...
      if ((0, _react.isValidElement)(children)) {
        clonedChild = (0, _react.cloneElement)(children, (0, _extends3.default)({}, childProps, { ref: this.targetRef }));
      } else {
        clonedChild = _react2.default.createElement(
          'span',
          (0, _extends3.default)({}, childProps, { ref: this.targetRef }),
          children
        );
      }
